...
/* Inside nestedFunction when we console  internal, the function looks to see if the variable internal is
is within the nestedFunction but when it can find it, it would go to the outer too look for the variable
until it finds it even globally. but myFunction can not access any variable declared within nestedFunction.*/
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(data){
    /*Your Code Here*/
    const lessPop  = data.filter(item => {
...
console.log('Topic 2, step 2 add:',consume(4, 5, add));
...
function multiply(a, b){
  ...
  console.log('Topic 2, step 2 multiply:',consume(4, 5, multiply));
...
function greeting(firstName, lastName){
  ...
  console.log('Topic 2, step 2 greeting:',consume('sirak', 'hailemichael', greeting));
...
console.log('Topic 3:',cuboid.surfaceArea()); // 130
